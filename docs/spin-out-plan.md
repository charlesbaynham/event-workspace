...
whatsapp:
  ...
  gate_exempt: [447795894857]                # §14-style exemptions, each with provenance
...
have no `rsync`, and GitHub refuses to serve an abbreviated sha, so a commit
ref must be the full 40 characters.
